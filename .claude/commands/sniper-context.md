...
Run `./sniper python3 -B scripts/producer/context.py` on macOS or
`sniper.cmd python3 -B scripts/producer/context.py` on Windows from the app folder (the Project Sniper root),
