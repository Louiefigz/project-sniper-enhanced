...
Styles (Sniper style specifications, one per built-in short-form preset): [`RESTRAINED_STYLE.md`](studies/RESTRAINED_STYLE.md) (steady frame, thesis card, captions carry the pace) · [`PUNCH_STYLE.md`](../scripts/producer/docs/findings/PUNCH_STYLE.md) (hard framing cuts, two text layers) · [`SLIDEWARE_STYLE.md`](studies/SLIDEWARE_STYLE.md) (slide sections, real evidence, no camera motion) · [`MODULE_STUDY.md`](studies/MODULE_STUDY.md) + [`MODULE_CARDS.md`](studies/MODULE_CARDS.md) · [`REFERENCE_STYLE_STUDY.md`](studies/REFERENCE_STYLE_STUDY.md)
