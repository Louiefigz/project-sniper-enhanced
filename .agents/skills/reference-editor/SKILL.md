...
Read `../../../.claude/skills/reference-editor/SKILL.md` completely, including
the required references it identifies, then follow it as the canonical Project
Sniper reference workflow.
