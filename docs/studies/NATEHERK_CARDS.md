# NATEHERK CARDS — card catalog, variety doctrine, screenshare grammar

Companion to `NATEHERK_STUDY.md` (pipeline/QC + transition grammar + adoption plan). This doc
...
catalog. Date: 2026-07-11. Source: `_references/nateherk/J_jswzXhYJA.webm` (323.4s,
...
widget-gauge, angela-* pack, text/container elements). `nateherk-takeover.html` EXISTS and
