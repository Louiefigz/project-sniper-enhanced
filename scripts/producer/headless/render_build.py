...
from .render_build_manifest_v3_contract import (
    RENDER_BUILD_V3_DIGEST_DOMAIN, RENDER_BUILD_V3_POLICY,
)
...
BUILD_POLICY = RENDER_BUILD_V4_POLICY
BUILD_SCHEMA_VERSION = 4
_IMPLEMENTATION_FILES = RENDER_BUILD_V4_IMPLEMENTATION_PATHS
...
def render_build_manifest_digest(manifest: dict) -> str:
    ...
    the closed V4 parser separately; digest dispatch never admits old execution.
    """
    ...
    versions = {
        ...
        (4, RENDER_BUILD_V4_POLICY): RENDER_BUILD_V4_DIGEST_DOMAIN,
    }
