...
in templates/motion/tokens.css as --font-serif-display (JADEN_STYLE.md G1).
...
--font-hand for the hw-* comps' callout labels; woff2 mirrored from
vendor/hyperframes-catalog/assets/fonts/Caveat-700-latin.woff2.
