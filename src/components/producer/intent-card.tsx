...
const PRESET_COPY: Record<string, { label: string; summary: string }> = {
  ...
  "restrained-light": { label: "Minimal captions (Restrained)", summary: "A restrained vertical style led by clean captions." },
  "punch-produced": { label: "Fast, graphic-rich (Punch)", summary: "A fast vertical style with punch cuts and layered text." },
  "slideware-involved": { label: "Graphic-led explainer (Slideware)", summary: "A bold explainer style with full-frame graphic sections." },
};
