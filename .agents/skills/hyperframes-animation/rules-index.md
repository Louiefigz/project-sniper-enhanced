...
<rules>
<gsap-effects path="rules/gsap-effects.md">Reusable GSAP timeline patterns — typewriter, audio visualizer, and other choreography blocks. Tags: gsap, recipe, reusable, typewriter, audio-visualizer</gsap-effects>
