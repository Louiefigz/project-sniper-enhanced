...
Styles: [`RESTRAINED_STYLE.md`](studies/RESTRAINED_STYLE.md) · `PUNCH_STYLE.md` (the copy the **code loads** is `scripts/producer/docs/findings/PUNCH_STYLE.md`; the one here is a shorter duplicate) · [`SLIDEWARE_STYLE.md`](studies/SLIDEWARE_STYLE.md) · [`MODULE_STUDY.md`](studies/MODULE_STUDY.md) + [`MODULE_CARDS.md`](studies/MODULE_CARDS.md) · [`REFERENCE_STYLE_STUDY.md`](studies/REFERENCE_STYLE_STUDY.md)
