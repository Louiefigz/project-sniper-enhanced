...
def scan_builtin_music(builtin_dir: Optional[Path],
    ...
    resolves out of the box on a project with no music folder (the Punch and
    Slideware styles recommend a bed the operator can opt into —
    PUNCH_STYLE.md §6 M1, SLIDEWARE_STYLE.md §7 AM1). Additive: ids continue the
