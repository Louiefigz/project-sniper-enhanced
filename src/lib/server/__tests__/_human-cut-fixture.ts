...
export async function createHumanCutFixture(options: { workspace?: string; workflowV2?: GuidedWorkflowV2; sourceCanvas?: "160x90" | "1920x1080";
  program?: SyntheticProgram; captionIntent?: "auto"; graphicsOff?: boolean; presentationAsset?: "admitted-silent-video" } = {}) {
  ...
  const fixture = guidedFixture(root, options.workflowV2, { reuseAuthored: options.program !== undefined, graphicsOff: options.graphicsOff });
