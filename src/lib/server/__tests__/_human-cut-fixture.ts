...
export async function createHumanCutFixture(options: { workspace?: string; workflowV2?: GuidedWorkflowV2; sourceCanvas?: "160x90" | "1920x1080";
  ...
  const fixture = guidedFixture(root, options.workflowV2, { reuseAuthored: options.program !== undefined, graphicsOff: options.graphicsOff, nativeShort: options.nativeShort });
