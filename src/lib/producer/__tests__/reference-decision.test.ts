...
assert.equal(parseReferenceDecision({ id: "ref_1", mode: "short", strategy: "extend", targetStyle: "restrained" }, at).targetStyle, "restrained");
...
assert.throws(() => parseReferenceDecision({ id: "ref_1", mode: "longform", strategy: "extend", targetStyle: "restrained" }, at), /shorts-only/);
assert.throws(() => parseReferenceDecision({ id: "ref_1", mode: "short", strategy: "extend", targetStyle: "unknown" }, at), /restrained/);
assert.throws(() => parseReferenceDecision({ id: "ref_1", mode: "short", strategy: "mimic", targetStyle: "restrained" }, at), /extend-only/);
...
assert.throws(() => parseReferenceDecision({ id: "ref_1", mode: "short", strategy: "new-style", candidateStyleName: "Restrained" }, at), /outside Restrained/);
